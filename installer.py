...
APPROVED_RC = {
    ...
    "tag": "v1.0.0-rc.20",
    "commit": "b520cd46486209b1892b3c23c9b2392e8f6f9365",
    "asset": "aven-v1.0.0-rc.20-bootstrap-b520cd464862.tar",
    "asset_size": 522240,
    "sha256": "058aa63e1fa4953a4b40ca7ad4a29fe61d0285edaec51dfd12a9f96e81aa7845",
    "checksum_asset": "aven-v1.0.0-rc.20-bootstrap-b520cd464862.tar.sha256",
    "build_report_asset": "aven-v1.0.0-rc.20-bootstrap-b520cd464862.build.json",
    "installation_lock_sha256": "cadc787392b3d22bf90b06a2d5d01e5faab86e3f190e6cdd9db0b036db2c8d61",
    "workbench_runtime_commit": "21aa36e1f42d6a434af9e449b88bb3b141d09b2b",
    "prerelease": True,
}
APPROVED_HEALTHY_PREDECESSORS = ({
    "aven_version": "1.0.0-rc.19",
    "installation_lock_sha256": "9a688a9f3fad9a6d94b5f8329c0f591f650e29e40bc4c851f41c1db45e784f76",
    "workbench_commit": "5c1892f56b16a28277ca4dcd5838e6ff315ef57d",
    "bootstrap_source_commit": "dbab68253c1b341624e9269d58997879a778fb09",
    "bootstrap_manifest_sha256": "5cc401d136bb19454ed201e325e28d157d74268a509977eabbdc9c4fbfcb9802",
},)
...
def load_channel(path: Path, requested_channel: str) -> Mapping[str, Any]:
    ...
    if value != APPROVED_RC:
        raise InstallerError(
            ...
            "the rc channel does not match the exact owner-approved Aven v1.0.0-rc.20 release",
        )
    return value
